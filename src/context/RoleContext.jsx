...
export const ROLE_ROUTES = {
    superadmin: [
        ...
        '/applications', '/trainer-applications', '/award-applications', '/judge-applications', '/restoration-applications', '/analytics', '/settings',
        ...INTRANET_ROUTES,
    ],
    admin: [
        '/dashboard', '/settings',
    ...
    employee: [
        ...
        '/organizations', '/facilities', '/events', '/teams',
        '/staff', '/medical-certificates', '/inventory',
        '/applications', '/trainer-applications', '/award-applications', '/judge-applications', '/restoration-applications', '/analytics',
        ...INTRANET_ROUTES,
    ],
    athlete: [
        '/dashboard', '/events',
