...
const GROUP_INFO = {
    ...
    B: { organ: 'Областное / городское управление физической культуры и спорта', term: '30 рабочих дней' },
    C: { organ: 'Спортивная школа / спортивная организация', term: '30 рабочих дней' },
}
