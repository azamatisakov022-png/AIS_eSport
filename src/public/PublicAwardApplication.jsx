...
const GROUP_INFO = {
    ...
    B: { organ: 'Областное управление физической культуры и спорта', term: '20 рабочих дней' },
    C: { organ: 'Аккредитованная спортивная организация / федерация', term: '15 рабочих дней' },
}
