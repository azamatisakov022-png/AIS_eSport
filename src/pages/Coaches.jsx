...
// Тренерское свидетельство бессрочно (Q16): статус только «действует» / «аннулировано»
function computeStatus(coach) {
    return coach.annulled ? 'annulled' : 'active'
}
                ...
                <table className="co-table">
                    <thead>
                        <tr>
                            ...
                            <th>{t('coaches.drawer.regDate')}</th>
                        ...
                        {filtered.map(c => {
                            return (
                                <tr key={c.id}>
                                    ...
                                    <td>{c.region}</td>
                                    <td style={{ whiteSpace: 'nowrap' }}>{fmt(c.regDate)}</td>
                        ...
                        <div className="co-drawer__body">
                            {tab === 'info' && (
                                <div className="co-info-grid">
                                    ...
                                    <div className="co-info-item">
                                        <div className="co-info-item__label">Срок действия</div>
                                        <div className="co-info-item__value">Бессрочно</div>
                                    </div>
                                    <div className="co-info-item">
