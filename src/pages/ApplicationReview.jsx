                    ...
                    <div className="ar-decision-panel">
                        ...
                        {transitions.includes('Отклонена') && (
                            <div style={{ fontSize: 12, color: '#64748b', marginBottom: 10, lineHeight: 1.4 }}>
                                Отказ оформляется совместно ответственным специалистом и руководителем отдела. Основание для званий — Единая спортивная классификация (не ПП КР №596 — оно относится к регистрации тренеров). При несоответствии документы возвращаются в рабочем порядке через Дирекции по видам спорта с объяснением причины; после устранения замечаний спортсмен может подать заново.
                            </div>
                        )}
